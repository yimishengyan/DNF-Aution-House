...
public class USERController {
    ...
    public String insertUser(@RequestBody User user){
        ...
        if(userService.selectUserName(user.getName()) == null)
    ...
    public User getUserInfo(@RequestParam String name){
        ...
        public String changeMoney(@RequestParam Integer userId, @RequestParam Double money){
            return userService.changeMoney(userId, money);
        }
    }
